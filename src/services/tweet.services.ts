...
import { T } from 'node_modules/@faker-js/faker/dist/airline-D6ksJFwG.cjs'
...
class TweetService {
  async checkAndCreateHashtags(hashtags: string[]) {
    ...
    return hashtagDocument.map((hashtag) => hashtag?._id).filter((id): id is ObjectId => id !== undefined)
  }
